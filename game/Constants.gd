...
const DIFFICULTY_HEALTH := 256
const DIFFICULTY_BOMBS := 512
const DIFFICULTY_ARROWS := 1024
const DIFFICULTY_CLAWS := 2048
const DIFFICULTY_XWIDTH := 4096
const DIFFICULTY_XXWIDTH := 8192
const DIFFICULTY_MASK := 255
