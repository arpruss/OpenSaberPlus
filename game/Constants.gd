...
const DIFFICULTY_XWIDTH := 0x1000
const DIFFICULTY_XXWIDTH := 0x2000
const DIFFICULTY_XXXWIDTH := 0x4000
const DIFFICULTY_SMALL := 0x10000
const DIFFICULTY_MASK := 255
const DIFFICULTY_WIDTH_MASK := DIFFICULTY_XWIDTH | DIFFICULTY_XXWIDTH | DIFFICULTY_XXXWIDTH
const DEFAULT_WIDTH := 100
const WIDTHS := [ [DEFAULT_WIDTH, 0], [125, DIFFICULTY_XWIDTH], [150, DIFFICULTY_XXWIDTH], [175, DIFFICULTY_XXXWIDTH] ]
